...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__SystemUse__copyl__2C3393D0] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[SystemUser] ADD CONSTRAINT [PK__SystemUs__E4276C1F10240AA1] PRIMARY KEY CLUSTERED  ([systemuserid])
GO
