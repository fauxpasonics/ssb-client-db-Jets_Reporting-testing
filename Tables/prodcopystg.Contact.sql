...
[copyloaddate] [datetime] NULL CONSTRAINT [DF_ProdCopy_Contact] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Contact] ADD CONSTRAINT [PK__Contact__7126F91D0A8F7CA2] PRIMARY KEY CLUSTERED  ([contactid])
GO
