...
[str_clientbilling] [nvarchar] (500) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[str_partnershipcomments] [nvarchar] (1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Account__copyloa__20C1E124] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Account] ADD CONSTRAINT [PK__Account__F20699F69E1BD640] PRIMARY KEY CLUSTERED  ([accountid])
GO
