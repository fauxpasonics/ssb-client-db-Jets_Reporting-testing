...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__SystemUse__copyl__2A4B4B5E] DEFAULT (getdate()),
[ssbpcisdeleted] [bit] NULL
)
GO
ALTER TABLE [prodcopy].[SystemUser] ADD CONSTRAINT [PK__SystemUs__E4276C1F90834742] PRIMARY KEY CLUSTERED  ([systemuserid])
GO
