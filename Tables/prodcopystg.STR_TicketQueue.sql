CREATE TABLE [prodcopystg].[STR_TicketQueue]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__STR_Ticke__copyl__239E4DCF] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[STR_TicketQueue] ADD CONSTRAINT [PK__STR_Tick__B1302CD1FC7470AE] PRIMARY KEY CLUSTERED  ([str_ticketqueueid])
GO
