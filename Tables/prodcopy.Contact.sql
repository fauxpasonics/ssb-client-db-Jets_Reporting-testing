...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Contact__copyloa__1A14E395] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopy].[Contact] ADD CONSTRAINT [PK__Contact__7126F91DCBC381F0] PRIMARY KEY CLUSTERED  ([contactid])
GO
